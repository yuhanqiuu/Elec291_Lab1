...
deg_complete:
	...
	mov x+2, #0
	mov x+3, #0
	Load_y(49900) ; VCC voltage measured (equals 4.99V)
	lcall mul32 ;multiplying ADC * Vref
	Load_y(4095) ; 2^12-1
	lcall div32 ;now doing (ADC*Vref)/(4095)
	
	;convert to temperature
	Load_y(27300) ;first load y = 2.73V
	lcall sub32 ;do vout-2.73
	Load_Y(100);load y = 100
	lcall mul32 ;finish temp calculation by multiplying x by 100
	
	;now check deg flag and convert if needed
	jb deg, celc
